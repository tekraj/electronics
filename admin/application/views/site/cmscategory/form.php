      ...
      <div class="col-lg-6">
        <form role="form" method="post" action="<?php echo isset($formData)? link_url.$title.'/update/'.$formData->id : link_url.$title.'/insertdata'; ?>" name="<?php echo $title.'-form' ?>" >
          ...
          <div class="form-group">
            <i>Title</i>
            <input name="cmscategory[title]" type="text" class="form-control" placeholder="Title..." value="<?php echo isset($formData)?$formData->title:''; ?>" id="beurl">
          </div>
           <div class="form-group">
            <i>URL</i>
            <input name="cmscategory[url]" type="text" class="form-control" placeholder="URL..." value="<?php echo isset($formData)?$formData->url:''; ?>" id="puturl">
          </div>

           <div class="form-group">
           <i>SEO Description</i>
            <input name="cmscategory[seoDesc]" type="text" class="form-control" placeholder="SEO Description..." value="<?php echo isset($formData)?$formData->seoDesc:''; ?>">
          </div>          
          <div class="form-group">
            <label>Status</label>
            
            <select name="cmscategory[status]" class="form-control" id="status">
              <?php
