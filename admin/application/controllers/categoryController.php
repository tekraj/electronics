...
class categoryController extends mainController{
	...
	public function insertdata(){
		...
		header('location:'.link_url.'category/');
	...
	public function search(){
		if(isset($_POST['searchby']) && isset($_POST['searchkey'])){
			if(!empty($_POST['searchkey'])){
				$_SESSION['categorySearch']=[];
				$_SESSION['categorySearch']['searchby']=$_POST['searchby'];
				$_SESSION['categorySearch']['searchkey']=$_POST['searchkey'];
			}			
		}
		header('location:'.link_url.'category/');		
	}
	...
	public function viewall(){
		...
		header('location:'.link_url.'category/view');
	}
}